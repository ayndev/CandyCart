    ...
    for (int i = 0; i < colors.count; i++) {
        ...
        if([type isEqualToString:@"simple"] || [type isEqualToString:@"external"] || [type isEqualToString:NULL])
        {
            ...
            if([boolean boolValue] == FALSE)
            {
                ...
                price.text = [NSString stringWithFormat:@"%@ %@", [[SettingDataClass instance] getCurrencySymbol],[pricing objectForKey:@"regular_price"]];
            ...
            else
            {
                ...
                NSString* regularPrice = [NSString stringWithFormat:@"%@ %@", [[SettingDataClass instance] getCurrencySymbol],[pricing objectForKey:@"regular_price"]];
                 NSString* salePrice = [NSString stringWithFormat:@"%@ %@", [[SettingDataClass instance] getCurrencySymbol],[pricing objectForKey:@"sale_price"]];
