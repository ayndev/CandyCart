            ...
            for (int i = 0; i<[productByCategoriesData count]; i++)
            {
                ...
                else
                {
                    ...
                    if([boolean boolValue] == FALSE)
                    {
                        ...
                        [self gridStyleNormal:[[productData objectForKey:@"product_gallery"] objectForKey:@"featured_images"] title:[[productData objectForKey:@"general"] objectForKey:@"title"] priceRegular:[NSString stringWithFormat:@"%@ %@", [[SettingDataClass instance] getCurrencySymbol],[[[productData objectForKey:@"general"] objectForKey:@"pricing"] objectForKey:@"regular_price"]] productInfo:productData];
                    }
                    else
                    {
                        NSLog(@"OnSale");
                        [self gridStyleOnSale:[[productData objectForKey:@"product_gallery"] objectForKey:@"featured_images"] title:[[productData objectForKey:@"general"] objectForKey:@"title"] priceRegular:[NSString stringWithFormat:@"%@ %@", [[SettingDataClass instance] getCurrencySymbol],[[[productData objectForKey:@"general"] objectForKey:@"pricing"] objectForKey:@"regular_price"]] salePrice:[NSString stringWithFormat:@"%@ %@", [[SettingDataClass instance] getCurrencySymbol],[[[productData objectForKey:@"general"] objectForKey:@"pricing"] objectForKey:@"sale_price"]] productInfo:productData];
                    }
...
-(void)gridStyleNormal:(NSString*)url title:(NSString*)str priceRegular:(NSString*)regularPrice productInfo:(NSDictionary*)productInfo{
    ...
    PhotoBox *box = [PhotoBox gridStyleNormal:CGSizeMake(145, 165) img:url title:str priceRegular:regularPrice];
