...
-(void)bottomView{
   ...
   // [self saleStartEndCountDown];
    ...
    if([[[productInfo objectForKey:@"linked_products"] objectForKey:@"upsells"] count] > 0)
    {
...
-(void)topView{
    ...
    if([[[productInfo objectForKey:@"general"] objectForKey:@"product_type"] isEqualToString:@"simple"] || [[[productInfo objectForKey:@"general"] objectForKey:@"product_type"] isEqualToString:@"external"])
    {
        ...
        if([boolean boolValue] == FALSE)
        {
            ...
            price.text = [NSString stringWithFormat:@"%@ %@", [[SettingDataClass instance] getCurrencySymbol],[[[productInfo objectForKey:@"general"] objectForKey:@"pricing"] objectForKey:@"regular_price"]];
        ...
        else
        {
            ...
            NSString *regular = [NSString stringWithFormat:@"%@ %@", [[SettingDataClass instance] getCurrencySymbol],[[[productInfo objectForKey:@"general"] objectForKey:@"pricing"] objectForKey:@"regular_price"]];
            
            NSString *sale_price = [NSString stringWithFormat:@"%@ %@", [[SettingDataClass instance] getCurrencySymbol],[[[productInfo objectForKey:@"general"] objectForKey:@"pricing"] objectForKey:@"sale_price"]];
...
-(void)addToCartBtn
{
    ...
    else if([[[productInfo objectForKey:@"general"] objectForKey:@"product_type"] isEqualToString:@"grouped"])
    {
        ...
        [self groupedProduct:featuredImage title:[[groupInfo objectForKey:@"general"] objectForKey:@"title"] currency: [[SettingDataClass instance] getCurrencySymbol] price:[[[groupInfo objectForKey:@"general"] objectForKey:@"pricing"] objectForKey:@"regular_price"] salePrice:[[[groupInfo objectForKey:@"general"] objectForKey:@"pricing"] objectForKey:@"sale_price"] isOnSale:[boolean boolValue] productInfo:groupInfo];
   ...
   if([ma count] > 0)
   {
       ...
       if([[product_variable objectForKey:@"featured_images"] isEqualToString:@"0"])
       {
           ...
           variablePrice.text = [NSString stringWithFormat:@"%@ %@",
                                 ...
                                 [[product_variable objectForKey:@"pricing"] objectForKey:@"regular_price"]];
       }
       else
       {
