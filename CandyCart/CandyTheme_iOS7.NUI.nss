...
//PRIMARY APP COLOR
    @PRIMARYCOLOR:#FFA500; //Effect Navigation Bar & Button Color & TableViewSelected
    @PRIMARYCOLOR_BOLD:#D2691E; //E.g On selected segment
    @OTHER_COLOR:#ffffff;
    @OTHER_COLOR_2:#aaaaaa; //Use in search background
