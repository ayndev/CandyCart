...
-(void)totalBox{
    ...
    *shipping = [MGLineStyled lineWithLeft:[NSString stringWithFormat:@"%@",NSLocalizedString(@"checkout_label_shipping_method_and_cost", nil)]
                                     right:[NSString stringWithFormat:@"%@ : %@ %.2f",[[MyCartClass instance] getServerCartValueByObjectKey:@"shipping-method"], [[SettingDataClass instance] getCurrencySymbol],[[[MyCartClass instance] getServerCartValueByObjectKey:@"shipping-cost"] floatValue]] size:CGSizeMake(300, 29)];
